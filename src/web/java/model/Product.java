...
public class Product {
	...
	public Product(int id, String title, String description, double rating, double priceDefault, int category,
			int collection, int brand, int discount, int qtt, int sold) {
		super();
		this.id = id;
		this.title = title;
