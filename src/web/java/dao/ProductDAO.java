...
public class ProductDAO {
		...
		try {
			...
			while (rs.next()) {
				products.add(new Product(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getDouble(4),
						rs.getDouble(5), rs.getInt(6), rs.getInt(7), rs.getInt(8), rs.getInt(9), rs.getInt(10), rs.getInt(11)));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void addProductAdmin(String title, String description, String price, String category, String collection,
			String brand, String discount) {
	...
	public void deleteProductById(String id) {
		String query = "DELETE FROM laptop.event_product WHERE product_id= ?";
		try {
			conn = new ConnectDB().getDBConnection();
			ps = conn.prepareStatement(query);
			ps.setString(1, id);
		...
		String query1 = "DELETE FROM laptop.image WHERE product_id= ?";
		try {
			conn = new ConnectDB().getDBConnection();
		...
		String query2 = "DELETE FROM laptop.product WHERE id= ?";
		try {
			conn = new ConnectDB().getDBConnection();
	...
	public void editProductById(String id, String title, String description, String price, String category,
			String collection, String brand, String discount) {
	...
	public List<Product> search(String search) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where title like '%"+ search +"%' limit 30 ";
	...
	public List<Product> searchtopfiveproducts(String search) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where title like '%"+ search +"%' limit 5 ";
	...
	public List<Product> getMostSoldInCategory(String id) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where cate_id = ? order by sold desc";
	...
	public List<Product> getSortAZInCategory(String id) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where cate_id = ? order by title asc";
	...
	public List<Product> getSortZAInCategory(String id) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where cate_id = ? order by title desc";
	...
	public List<Product> getSortPriceInCategory(String id) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where cate_id = ? order by price_default asc";
	...
	public List<Product> getSortPriceDesCategory(String id) {
		List<Product> products = new ArrayList<Product>();
		String query = "select * from product where cate_id = ? order by price_default desc";
